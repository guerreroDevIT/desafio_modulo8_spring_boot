...
public class CHabilidades {
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id){
        ...
        return new ResponseEntity(new Mensaje("Habilidades eliminada"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> create(@RequestBody dtoHabilidades dtohabilidades){
        ...
        Habilidades habilidades = new Habilidades(
                dtohabilidades.getNombreE(), dtohabilidades.getDescripcionE(), dtohabilidades.getPorcentaje()
            );
        sHabilidades.save(habilidades);
        return new ResponseEntity(new Mensaje("Habilidades creada"), HttpStatus.OK);
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoHabilidades dtohabilidades){
        ...
        habilidades.setDescripcionE(dtohabilidades.getDescripcionE());
