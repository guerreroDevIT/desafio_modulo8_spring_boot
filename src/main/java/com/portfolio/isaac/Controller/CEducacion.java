...
import com.portfolio.isaac.Dto.dtoEducacion;
import com.portfolio.isaac.Entity.Educacion;
import com.portfolio.isaac.Security.Controller.Mensaje;
import com.portfolio.isaac.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getPeriodoE(), dtoeducacion.getTituloE()
            );
